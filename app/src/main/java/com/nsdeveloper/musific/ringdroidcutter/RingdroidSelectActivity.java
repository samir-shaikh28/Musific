...
package com.nsdeveloper.musific.ringdroidcutter;
...
import com.nsdeveloper.musific.ringdroidcutter.soundfile.SoundFile;
...
//            mWasGetContentIntent = intent.getAction().equals(
        ...
        delegate.setContentView(R.layout.media_select);
...
//                else if (view.getId() == R.id.albumArt) {
...
//        }
    ...
    public boolean onPrepareOptionsMenu(Menu menu) {
      ...
      //  menu.findItem(R.id.action_search_filter).setVisible(true);
    ...
    public boolean onOptionsItemSelected(MenuItem item) {
        ...
        case R.id.action_record:
            ...
            if (Nammu.checkPermission(Manifest.permission.RECORD_AUDIO) ) {
                ...
                if (Nammu.shouldShowRequestPermissionRationale(this, Manifest.permission.RECORD_AUDIO)) {

                    Snackbar.make(getCurrentFocus(), "Musific will need access to microphone to record audio.",
                            Snackbar.LENGTH_INDEFINITE)
                            .setAction("OK", new View.OnClickListener() {
                                @Override
                                public void onClick(View view) {
                                    Nammu.askForPermission(RingdroidSelectActivity.this,
                                            new String[]{Manifest.permission.RECORD_AUDIO}, new PermissionCallback() {
                                                @Override
                    ...
                    Nammu.askForPermission(this, new String[]{Manifest.permission.RECORD_AUDIO}, new PermissionCallback() {
                        @Override
                        public void permissionGranted() {
                            onRecord();
                        }
...
//            title = getResources().getText(R.string.delete_notification);
    ...
    private void onRecord() {
        try {
            ...
            intent.setClassName( RingdroidSelectActivity.this, "com.nsdeveloper.musific.ringdroidcutter.RingdroidEditActivity");
