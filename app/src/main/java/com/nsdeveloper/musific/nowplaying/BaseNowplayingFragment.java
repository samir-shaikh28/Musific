...
import com.nsdeveloper.musific.adapters.BaseQueueAdapter;
...
import com.nsdeveloper.musific.timely.TimelyView;
...
import com.nsdeveloper.musific.utils.SlideTrackSwitcher;
import com.nsdeveloper.musific.utils.TimberUtils;
import com.nsdeveloper.musific.widgets.CircularSeekBar;
import com.nsdeveloper.musific.widgets.DividerItemDecoration;
import com.nsdeveloper.musific.widgets.PlayPauseButton;
import com.nsdeveloper.musific.widgets.PlayPauseDrawable;
                ...
                ImageLoader.getInstance().displayImage(TimberUtils.getAlbumArtUri(MusicPlayer.getCurrentAlbumId()).toString(), albumart,
                        new DisplayImageOptions.Builder().cacheInMemory(true)
                            ...
                            public void onLoadingFailed(String imageUri, View view, FailReason failReason) {
                                Bitmap failedBitmap = ImageLoader.getInstance().loadImageSync("drawable://" + R.drawable.ic_musific_empty);
