...
public class Constants {
    ...
    public static final String NAVIGATE_GENRE = "navigate_genre";
    ...
    public static final String GENRE_ID = "playlist_id";
    ...
    public static final String NAVIGATE_CUTTER = "navigate_cutter";
