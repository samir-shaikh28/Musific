...
import com.nsdeveloper.musific.adapters.GenreSongAdapter;
import com.nsdeveloper.musific.dataloaders.GenreLoader;
import com.nsdeveloper.musific.dataloaders.GenreSongLoader;
...
import com.nsdeveloper.musific.utils.FabAnimationUtils;
...
public class GenreDetailFragment extends Fragment {
    ...
    TextView genreTitle, genreDetails;

    RecyclerView recyclerView;
    GenreSongAdapter mAdapter;
    ...
    public static GenreDetailFragment newInstance(long id, boolean useTransition, String transitionName) {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        final View rootView = inflater.inflate(
                R.layout.fragment_genre_detail, container, false);

        albumArt = (ImageView) rootView.findViewById(R.id.album_art);
        artistArt = (ImageView) rootView.findViewById(R.id.artist_art);
        genreTitle = (TextView) rootView.findViewById(R.id.album_title);
        genreDetails = (TextView) rootView.findViewById(R.id.album_details);
        ...
        genre = GenreLoader.getGenre(getActivity(), genreID);
        ...
        fab.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                handler.postDelayed(new Runnable() {
                    @Override
                    public void run() {
                        GenreSongAdapter adapter = (GenreSongAdapter) recyclerView.getAdapter();
                        MusicPlayer.playAll(getActivity(), adapter.getSongIds(), 0, genreID, TimberUtils.IdType.Genre, true);
    ...
    private void setupToolbar() {
        ...
        collapsingToolbarLayout.setTitle(genre.title);

    }

    private void setAlbumart() {
        ImageLoader.getInstance().displayImage(TimberUtils.getAlbumArtUri(genreID).toString(), albumArt,
    ...
    private void setGenreDetails() {
        ...
        genreTitle.setText(genre.title);
    ...
    private void setUpGenreSongs() {
        ...
        List<Song> songList = GenreSongLoader.getSongsForGenre(getActivity(), genreID);
        mAdapter = new GenreSongAdapter(getActivity(), songList, genreID);
    ...
    public boolean onOptionsItemSelected(MenuItem item) {
        switch (item.getItemId()) {
            case R.id.menu_sort_by_az:
                mPreferences.setGenreSongSortOrder(SortOrder.GenreSongSortOrder.SONG_A_Z);
                reloadAdapter();
                return true;
            case R.id.menu_sort_by_za:
                mPreferences.setGenreSongSortOrder(SortOrder.GenreSongSortOrder.SONG_Z_A);
                reloadAdapter();
                return true;
        }
